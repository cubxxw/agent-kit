...
- Read the nearest repository instructions before acting.
- Preserve user changes and keep unrelated work out of the current scope.
- Never expose or commit credentials, authentication state, private notes, or
