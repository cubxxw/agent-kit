...
| [`anthropics/skills` frontend and web testing](https://github.com/anthropics/skills) | Visual direction and browser verification | Invoke only when taste or real browser behavior is the variable; do not make either the default probe loop |
